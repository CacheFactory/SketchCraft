...
import { IRenderer, IRenderStats } from '../core/interfaces';
import { Vec3, Color, RenderMode } from '../core/types';
...
import { createXRayMaterial, createXRayWireframeMaterial } from './shaders/XRayShader';
